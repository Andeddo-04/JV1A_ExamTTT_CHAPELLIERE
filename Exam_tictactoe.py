...
def turn_j1(tab:list):
    ...
    j1 = int(input("Joueur 1, où voulez vous jouer ? (1/2/3/4/5/6/7/8/9) "))-1
...
def turn_j2(tab:list):
    ...
    j2 = int(input("Joueur 2, où voulez vous jouer ? (1/2/3/4/5/6/7/8/9) "))-1
...
def game(tab):
    ...
    print(grille(my_tab))
    bloqueur = test_grille_complete(tab)
    
    while bloqueur == False:
        
        if test_grille_complete(tab) is not True:
            print(turn_j1(tab))
            test_win(tab)
